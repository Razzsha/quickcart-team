    ...
    if (step === "signup") {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setMessage("OTP sent to your WhatsApp number. Please check and verify.");
          setStep("verify");
        } else {
              ...
              <>
                <div className="bg-green-50 border border-green-200 rounded p-4 mb-4">
                  <p className="text-sm text-green-800">
                    OTP has been sent to your WhatsApp number. Please check your messages and enter the 6-digit code below.
                  </p>
                </div>
                <input
