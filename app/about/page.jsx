...
const AboutPage = () => {
  const values = [
    ...
    { title: 'Easy Support', desc: 'WhatsApp notifications and support when you need us.' }
  ]
      ...
      <div className="min-h-screen bg-white">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
              <div className="flex-1">
                ...
                <p className="text-gray-600 mb-8">
                  Founded with a mission to bring convenience to online shopping, we integrate WhatsApp 
                  for seamless order updates and support. From signup to delivery, we stay connected with you every step of the way.
                </p>
          ...
          <div className="max-w-6xl mx-auto px-6 md:px-16 lg:px-32">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
              ...
              <div>
                ...
                <div className="text-orange-100 text-sm mt-1">WhatsApp Support</div>
              </div>
              <div>
        ...
        <div className="py-16 md:py-24">
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            <p className="text-gray-600 mb-8">
              Join thousands of satisfied customers. Sign up today and get order updates via WhatsApp.
            </p>
