...
const faqs = [
  { q: 'How do I place an order?', a: 'Sign in, add items to your cart, select a delivery address, and click Place Order. You\'ll receive a WhatsApp confirmation.' },
  ...
  { q: 'How does WhatsApp verification work?', a: 'When you sign up, we send an OTP to your WhatsApp number. Enter it on the verification page to activate your account.' },
